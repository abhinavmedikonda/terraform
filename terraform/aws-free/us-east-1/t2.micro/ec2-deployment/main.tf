...
module "instance" {
  source         = "git::https://github.com/abhinavmedikonda/terraform.git//modules/aws/instance?ref=main"
...
module "vpc" {
  source            = "git::https://github.com/abhinavmedikonda/terraform.git//modules/aws/vpc?ref=main"
  az                = var.az
